...
import {
  ...
  TrendingUp, Users, Award, Shield, Lightbulb, FlaskConical,
  Code2, Calculator, AtomIcon, Globe, ChevronRight, Play,
  RotateCcw, Send, Cpu
} from "lucide-react";
import {
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-[#7878a0] text-xs font-['JetBrains_Mono',monospace]">Học viên điển hình • 12 tuần</p>
            </div>
        ...
        >
          <div className="grid md:grid-cols-[1fr_280px] gap-8">
            ...
            <div className="rounded-xl bg-[#08080f]/60 border border-white/6 p-5 flex flex-col">
              <div className="text-xs text-[#7878a0] font-['JetBrains_Mono',monospace] mb-1">Hiệu quả học tập</div>
...
function Subjects() {
  const subjects = [
    ...
    },
    {
      ...
      name: "Toán Cao Cấp",
      code: "MATH201",
      desc: "Giải tích, đại số tuyến tính, xác suất thống kê và ứng dụng trong khoa học máy tính.",
          ...
          >
            ...
            <div className="flex items-center gap-3 px-5 py-4 border-b border-white/5 bg-[#0e0e20]">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-[#7878a0] font-['JetBrains_Mono',monospace]">Elo bạn: <span className="text-cyan-400">950</span></div>
              </div>
...
function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Học bình thường bạn ôn đều đặn mỗi ngày, không phân biệt bài nào đã thuộc hay chưa. SM-2 tính toán khoảng cách tối ưu giữa các lần ôn dựa trên mức độ ghi nhớ của bạn — bài đã thuộc sẽ ôn sau 1 tuần, bài chưa thuộc ôn sau 1 ngày. Kết quả là học ít hơn 40% thời gian mà nhớ lâu hơn gấp đôi.",
    },
    {
    ...
    },
    {
      ...
      a: "Hoàn toàn miễn phí trong giai đoạn beta. Tất cả tính năng — Elo Rating, Spaced Repetition, Dashboard analytics, AI Tutor và toàn bộ ngân hàng câu hỏi — đều được mở không giới hạn cho sinh viên đăng ký.",
    },
  ];
